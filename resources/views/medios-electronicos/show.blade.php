    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Registro de medio electrónico #{{ $registro->id }}
            </h2>
            ...
            <div class="bg-white rounded-2xl shadow p-6 space-y-6">
                ...
                <div class="border-b pb-4">
                    ...
                    <p class="text-sm text-gray-500">
                        Detalle completo del registro capturado.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 font-medium">{{ $registro->organizacion_nombre ?? 'Sin organización' }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 font-medium">
                            {{ $registro->tipo_eleccion_nombre ?? 'Sin tipo de elección' }}</p>
                    </div>

                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase">Portal</p>
                        <p class="text-gray-800 font-medium">{{ $registro->portal_nombre ?? 'Sin portal' }}</p>
                    </div>
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-500 uppercase mb-1">URL de la publicación</p>

                    @if ($registro->url_pagina)
                        <a href="{{ $registro->url_pagina }}" target="_blank"
                            class="text-blue-600 hover:underline break-all">
                            {{ $registro->url_pagina }}
                        </a>
                    @else
                        <p class="text-gray-500">Sin URL</p>
                    @endif
                </div>
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                            ...
                            <p class="text-gray-800 font-medium">{{ $registro->cuali_valoracion ?: 'Sin valoración' }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium">
                                {{ $registro->cuali_lenguaje_inclusivo ?: 'Sin dato' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium">{{ $registro->violencia_tema_nombre ?? 'Sin tema' }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium">
                                {{ $registro->cuali_tipo_eleccion_nombre ?? 'Sin tipo' }}</p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold text-gray-500 uppercase">Modalidad</p>
                            <p class="text-gray-800 font-medium">{{ $registro->cuali_modalidad ?: 'Sin modalidad' }}
                            </p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold text-gray-500 uppercase">Objetividad</p>
                            <p class="text-gray-800 font-medium">{{ $registro->cuali_objetividad ?: 'Sin dato' }}</p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold text-gray-500 uppercase">Tipo de mensaje</p>
                            <p class="text-gray-800 font-medium">
                                {{ $registro->cuali_tipo_mensaje ?: 'Sin tipo de mensaje' }}</p>
                        </div>

                        <div>
                            <p class="text-xs font-semibold text-gray-500 uppercase">Formato</p>
                            <p class="text-gray-800 font-medium">{{ $registro->cuali_formato ?: 'Sin formato' }}</p>
                        </div>
                    </div>
                ...
                <div class="border-t pt-6 flex flex-col sm:flex-row gap-3 justify-end">
                    <a href="{{ route('m-electronicos-testigo', $registro->id) }}" target="_blank"
                        class="inline-flex justify-center rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700">
                        Ver testigo PDF
                    </a>

                    <a href="{{ route('m-electronicos-index') }}"
                        class="inline-flex justify-center rounded-lg bg-neutral-700 px-4 py-2 text-sm font-semibold text-white hover:bg-neutral-800">
                        Ir a medios electrónicos
                    </a>
                </div>
