...
<body>
    @php
        ...
        $siglasBanda = trim(($registro->medio_siglas ?: '') . ' ' . ($registro->medio_banda ?: ''));
    ...
    <div class="box top-box">
        ...
        <p><span class="label">Siglas:</span> <span class="value">{{ $siglasBanda ?: 'SIN DATO' }}</span></p>
        <p><span class="label">Locutor:</span><span class="value">{{ $registro->nombre_autor ?: 'SIN LOCUTOR' }}</span></p>
    </div>
        ...
        <tr>
            <td class="left-col">
                <div class="box info-box">
                    ...
                    <p><span class="label">Grupo:</span> <span class="value">{{ $registro->medio_grupo_radiofonico ?: 'SIN GRUPO' }}</span></p>
