...
<body>
    @php
        ...
        $fecha = $registro->fecha
            ? $registro->fecha->format('d') .
                '-' .
                ($meses[$registro->fecha->format('M')] ?? strtoupper($registro->fecha->format('M'))) .
                '-' .
                $registro->fecha->format('Y')
            : '';
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="header-text">
                    ...
                    TIPO: SITIOS WEB Y REDES SOCIALES<br>
            ...
            <td class="right-col">
                <div class="box info-box-right">
                    <p>
                        ...
                        <span class="uppercase">
                            {{ $registro->portal_nombre ?: 'SIN PÁGINA WEB' }}
                        </span>
                    </p>
