<div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-lg font-semibold text-gray-800">
                        {{ $periodoId ? 'Editar periodo' : 'Registrar periodo' }}
                    </h2>

                    <p class="text-sm text-gray-500">
                        Captura el nombre del periodo.
                    </p>
                </div>
            ...
            <form wire:submit.prevent="{{ $periodoId ? 'actualizar' : 'guardar' }}" class="space-y-4">
                <div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Busca y administra los periodos.
                    </p>
                </div>
                        ...
                        @forelse ($periodos as $periodo)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm text-center">
                                    <button
                                        type="button"
                                        wire:click="confirmarEliminar({{ $periodo->id }})"
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-3 text-sm text-gray-600">
                            Esta acción no se podrá deshacer. Si el periodo está relacionado con monitoreos, el sistema no permitirá eliminarlo.
                        </p>
                    </div>
                </div>
