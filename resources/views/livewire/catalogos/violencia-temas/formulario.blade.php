<div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-lg font-semibold text-gray-800">
                        {{ $violenciaTemaId ? 'Editar tema de violencia' : 'Registrar tema de violencia' }}
                    </h2>

                    <p class="text-sm text-gray-500">
                        Captura el nombre del tema de violencia.
                    </p>
                </div>
            ...
            <form wire:submit.prevent="{{ $violenciaTemaId ? 'actualizar' : 'guardar' }}" class="space-y-4">
                <div>
                ...
                <div>
                    <x-button>
                        {{ $violenciaTemaId ? 'Actualizar' : 'Guardar' }}
                    </x-button>
                </div>
            </form>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                <div>
                    <h2 class="text-lg font-semibold text-gray-800">
                        Temas de violencia registrados
                    </h2>

                    <p class="text-sm text-gray-500">
                        Busca y administra los temas de violencia.
                    </p>
                </div>
            ...
            <div class="overflow-x-auto border border-gray-200 rounded-lg">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($violenciaTemas as $violenciaTema)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3 text-sm">
                                    <button
                                        type="button"
                                        wire:click="editar({{ $violenciaTema->id }})"
                                        class="text-primary-600 hover:text-primary-900 font-medium"
                                    >
                                        {{ $violenciaTema->nombre }}
                                    </button>
                                </td>
                                ...
                                <td class="px-4 py-3 text-sm text-center">
                                    <button
                                        type="button"
                                        wire:click="confirmarEliminar({{ $violenciaTema->id }})"
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="px-4 py-6 text-center text-sm text-gray-500">
                                    No hay temas de violencia registrados.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">
                            Eliminar tema de violencia
                        </h3>

                        <p class="mt-2 text-sm text-gray-600">
                            ¿Deseas eliminar este tema de violencia?
                        </p>
