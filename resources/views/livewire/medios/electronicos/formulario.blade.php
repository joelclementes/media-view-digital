        ...
        <div class="space-y-6">
            ...
            <div class="rounded-lg bg-white p-5 shadow-md">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                    ...
                    <div><span class="block text-xs font-semibold uppercase text-gray-500">Fecha
                            Pub.:</span>{{ $registro_cualitativo['fecha'] ?? '' }}</div>
                    <div><span class="block text-xs font-semibold uppercase text-gray-500">Medio
                            electrónico</span>{{ $registro_cualitativo['portal'] ?? '' }}</div>
                    ...
                    <div><span class="block text-xs font-semibold uppercase text-gray-500">Url:</span>
